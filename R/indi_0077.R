#' Indicator: Mortalidade por neoplasias malignas do tecido linfatico hematopoetico e tecidos correlatos
#'
...
#' @examples
#' # Some examples
#' indi_0077(agg = "mun_res", ano = 2013)
#'
...
indi_0077 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) IN ('C81', 'C82', 'C83', 'C84', 'C85', 'C88', 'C90', 'C91', 'C92', 'C93', 'C94', 'C95', 'C96')"
