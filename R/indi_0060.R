#' Indicator: Mortalidade por transtornos mentais e comportamentais devidos ao uso de alcool
#'
...
#' @examples
#' # Some examples
#' indi_0060(agg = "mun_res", ano = 2013)
#'
...
indi_0060 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) = 'F10'"
