#' Indicator: Taxa de incidência de leishmaniose tegumentar
#'
...
#' @export
indi_0020 <- function(agg, agg_time = "year", ano, multi = 100000, decimals = 2, complete_with_zeros = TRUE, keep_raw_values = FALSE, save_args = FALSE){

  # Creates numerator
  numerador <- recbilis::get_leish_teg(
    agg = agg,
    agg_time = agg_time,
    ano = ano
  )
