#' Indicator: Mortalidade por apendicite hernia e obstrucao intestinal
#'
...
#' @examples
#' # Some examples
#' indi_0088(agg = "mun_res", ano = 2013)
#'
...
indi_0088 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) BETWEEN 'K35' AND 'K46' OR LEFT(CAUSABAS, 3) = 'K56'"
