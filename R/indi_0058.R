#' Indicator: Mortalidade por cirrose e outras doencas cronicas do figado
#'
...
#' @examples
#' # Some examples
#' indi_0058(agg = "mun_res", ano = 2013)
#'
...
indi_0058 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) IN ('K70', 'K71', 'K72', 'K73', 'K74', 'K75', 'K76')"
