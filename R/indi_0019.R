#' Indicator: Taxa de incidência de doença de chagas
#'
...
#' @export
indi_0019 <- function(agg, agg_time = "year", ano, multi = 100000, decimals = 2, complete_with_zeros = TRUE, keep_raw_values = FALSE, save_args = FALSE){

  # Creates numerator
  numerador <- recbilis::get_chagas(
    agg = agg,
    agg_time = agg_time,
    ano = ano
  )
