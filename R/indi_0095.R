#' Indicator: Mortalidade por sintomas sinais e achados anormais nao classificados em outra parte
#'
...
#' @examples
#' # Some examples
#' indi_0095(agg = "mun_res", ano = 2013)
#'
...
indi_0095 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 1) = 'R'"
