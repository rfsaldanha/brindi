#' Indicator: Mortalidade por transtornos mentais e comportamentais devidos ao uso de drogas
#'
...
#' @examples
#' # Some examples
#' indi_0061(agg = "mun_res", ano = 2013)
#'
...
indi_0061 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) IN ('F11', 'F12', 'F13', 'F14', 'F15', 'F16', 'F17', 'F18', 'F19')"
