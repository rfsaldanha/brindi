#' Indicator: Mortalidade por lesoes autoprovocadas intencionalmente exceto enforcamento e arma de fogo
#'
...
#' @examples
#' # Some examples
#' indi_0097(agg = "mun_res", ano = 2013)
#'
...
indi_0097 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) BETWEEN 'X60' AND 'X84'"
