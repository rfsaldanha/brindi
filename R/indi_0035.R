#' Indicator: Taxa de mortalidade por doença de Chagas
#'
...
#' @examples
#' # Some examples
#' indi_0035(agg = "mun_res", ano = 2013)
#'
...
indi_0035 <- function(
  ...
  Q1 <- glue::glue_collapse(
    sQuote(rpcdas::cid_seq("B570", "B575"), q = FALSE),
    sep = ", "
  )
  
  filter_query <- glue::glue("LEFT(CAUSABAS, 3) IN ({Q1}, 'K231', 'K931')"
  )
