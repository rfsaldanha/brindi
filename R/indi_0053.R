#' Indicator: Mortalidade por doencas cerebrovasculares
#'
...
#' @examples
#' # Some examples
#' indi_0053(agg = "mun_res", ano = 2013)
#'
...
indi_0053 <- function(
  ...
  filter_query <- "LEFT(CAUSABAS, 3) IN ('I60', 'I61', 'I62', 'I63', 'I64', 'I65', 'I66', 'I67', 'I68', 'I69')"
